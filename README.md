...
Then running path looks like 
  ...
  python src/upload_dataset.py --model <model>
   ...
   rn this uploads 50 things from the coco dataset, idk bro it's a start 
...
For each of the 5 models this compiles all encoders, fires off profile jobs, runs inference, and prints Recall@10. Add --topk faiss to use the baked-index  
